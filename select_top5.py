...
grained_preds_top5 = eval(open('result/grained/preds_top5').read())  # [[label id,logistics],...]
coarse_preds_top5 = eval(open('result/coarse/preds_top5').read())
num = len(labels)
...
with open("result/grained/preds_top5_probs", 'w') as f:
    f.write(str(grained_preds_top5))
with open("result/coarse/preds_top5_probs", 'w') as f:
